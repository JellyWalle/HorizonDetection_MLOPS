...
file_list = glob.glob("test_images\images\*")
...
for filename in file_list:
    ...
    images_path = os.path.join("test_images", "images", filename+".jpg")
    sky_path = os.path.join("test_images", "masks", "sky", filename+".png")
    land_path = os.path.join("test_images", "masks", "land", filename+".png")
